...
export default function BookedApartmentDetails({
  apartmentId,
  checkInOutDate,
  apartment
}) {
          ...
          >
            {apartment?.images?.map((image) => (
              ...
              >
                <Image
                  src={image?.url}
                  alt={`Photo of the ${apartment?.name} hotel.`}
                  height={900}
                  width={900}
        ...
        <CardContent className="grid gap-6 p-6 md:grid-cols-2">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">{apartment?.shortDescription}</p>
            </div>

            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-2 text-gray-600">
                <Maximize className="h-4 w-4" />
                <span className="text-base">{apartment?.roomSize} sq ft</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                {getNumberOfNights(checkInOutDate?.from, checkInOutDate?.to) >
                  0 && (
