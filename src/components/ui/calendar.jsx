  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-p1 text-gray-50 hover:bg-p1 hover:text-gray-50 focus:bg-p1 focus:text-gray-50 dark:bg-gray-50 dark:text-p1 dark:hover:bg-gray-50 dark:hover:text-p1 dark:focus:bg-gray-50 dark:focus:text-p1",
        day_today: "bg-gray-100 text-p1 dark:bg-gray-800 dark:text-gray-50",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-light-sky-blue aria-selected:text-gray-900 dark:aria-selected:bg-gray-800 dark:aria-selected:text-gray-50",
